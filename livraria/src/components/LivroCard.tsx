...
export const LivroCard: React.FC<cardProps> = ({ id ,autor, titulo, urlFoto, preco }) => {

    return (
        <div  className={`cardLivro transition-all duration-300 max-h-screen   flex flex-col  items-center mx-4 my-2   rounded-t-sm`}>
